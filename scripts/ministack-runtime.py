...
def main():
    ...
    measurement_config=json.loads((ROOT/'proof/ministack/measurements.json').read_text()) if args.measurements or args.external_recorder else None
    ...
    try:
        ...
        if args.external_recorder:
            ...
            recorder=recorder_lifecycle.RecorderLifecycle(evidence,ROOT/'.local/bin/xenon-trace-recorder',launch,recorder_lifecycle.config(ROOT/'proof/ministack/recorder.json'))
