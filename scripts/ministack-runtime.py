...
def main():
    ...
    modes.add_argument('--smoke',action='store_true',help='run the unchanged smoke explicitly')
    args=parser.parse_args()
    cut_config=temporal_cut.validate_config(json.loads((ROOT/'proof/ministack/process-cut.json').read_text())) if args.process_cut_stage else None
