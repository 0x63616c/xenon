...
def main():
 ...
 try:
  ...
  expected={'TestXenonSignalMetadataContract','TestXenonOptionalSignalContract','TestXenonRequiredSignalStillDrains','TestXenonCANSignalScope','TestXenonOptionalDeliveryExecutes','TestXenonOptionalCancellationAndNoHandlerDrain','TestXenonLateSignalWithStartFallback'}
