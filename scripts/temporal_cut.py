...
def validate_config(value):
    expected={'schema':1,'stages':list(STAGES),'pause_timeout_ms':5000,'candidate_timeout_seconds':20,'control_port_offset':200,'update_mode':'update-only','fault':'SIGKILL','recovery_budget':'proof/ministack/case.json:recovery_seconds','full_acceptance':False}
