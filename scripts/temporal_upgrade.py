...
SEAMS = [
    ...
    ('serialization', ('api/persistence/', 'proto/internal/', 'common/codec/', 'common/primitives/', 'common/converter/'), ['proto/xenon/v1', 'internal/temporal/adapter/execution_codec.go', 'internal/node'], ['go-runtime-stores', 'go-visibility']),
