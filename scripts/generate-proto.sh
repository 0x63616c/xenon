...
PATH="$PWD/.local/tools:$PATH" protoc -I proto --go_out=. --go_opt=module=github.com/0x63616c/xenon --go-grpc_out=. --go-grpc_opt=module=github.com/0x63616c/xenon proto/xenon/v1/queue.proto
