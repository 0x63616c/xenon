...
PATH="$PWD/.local/tools:$PATH" protoc --go_out=. --go_opt=module=github.com/0x63616c/xenon --go-grpc_out=. --go-grpc_opt=module=github.com/0x63616c/xenon -I proto --go_opt=paths=import proto/xenon/v1/persistence.proto proto/xenon/v1/metadata.proto proto/xenon/v1/cluster.proto proto/xenon/v1/queuev2.proto
