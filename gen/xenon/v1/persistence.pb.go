...
const file_xenon_v1_persistence_proto_rawDesc = "" +
	"\n" +
	"\x1axenon/v1/persistence.proto\x12\bxenon.v1\x1a\x17xenon/v1/metadata.proto\x1a\x14xenon/v1/queue.proto\"\xb9\x02\n" +
	"\fShardCommand\x12/\n" +
	...
	"\bencoding\x18\x03 \x01(\x05R\bencoding\"\xfd\x01\n" +
	"\rStoredOutcome\x12%\n" +
...
var file_xenon_v1_persistence_proto_goTypes = []any{
	...
	(*QueueResult)(nil),    // 8: xenon.v1.QueueResult
}
var file_xenon_v1_persistence_proto_depIdxs = []int32{
	...
	8, // 5: xenon.v1.StoredOutcome.queue_result:type_name -> xenon.v1.QueueResult
